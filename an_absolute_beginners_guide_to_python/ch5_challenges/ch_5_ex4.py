...
while choice != 'q':
    ...
    if choice == '1':
        ...
        grandfather = input("\nEnter 'y' if you would like to see their grandfather as well: ")
        if grandfather.lower() == 'y':
            grandfather = father_son[directory[view]]
            if father_son.get(grandfather, 'not found') == 'not found':
                print("No grandfather information found")
            else:
                grandfather = father_son[grandfather]
                print("\nYou selected {}, their father is {}, their grandfather is"""
                      "{}".format(directory[view], father_son[directory[view]], grandfather))
